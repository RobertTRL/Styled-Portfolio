...
export default function Contacts({ isDark }) {
  ...
  function handleLinkClick(e, item) {
    ...
    // 'call' and 'link' actions just follow their href natively — no interception needed
  }
      ...
      <div className="contacts-inner">
        ...
        <div className="contacts-columns">
          ...
          <div className="contacts-column">
            <p className="contacts-column-label">Take my contacts</p>
          ...
          <div className="contacts-column">
            <p className="contacts-column-label">Send me a text directly</p>
            <ContactForm />
          </div>
