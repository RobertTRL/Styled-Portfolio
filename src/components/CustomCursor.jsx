...
import cursorText       from "../assets/Document1.svg";
...
export default function CustomCursor() {
  ...
  return (
    <div
      ref={cursorRef}
      className={`custom-cursor custom-cursor--${cursorState} ${visible ? "custom-cursor--visible" : ""}`}
      aria-hidden="true"
    >
      {/* Using <img> instead of background-image so SVGs render with their own styles */}
      <img
